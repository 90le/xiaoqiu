...
#
#     /var/xiaoqiu/mcp-servers/oauth/<server>.json
...
OAUTH_DIR = "/var/xiaoqiu/mcp-servers/oauth"
...
def _authorize_deeplink(server_name):
    ...
    return "[Authorize](xiaoqiu://settings/mcp-servers/%s)" % quote(server_name, safe="")
