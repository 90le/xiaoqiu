...
/**
 * Exposes `<filesDir>/xiaoqiu-global/{memory,skills,shared}` to the system
 ...
 * ```xml
 * <provider android:name=".providers.XiaoQiuDocumentsProvider"
 *     android:authorities="com.xiaoqiu.xiaoqiu.documents"
 ...
 * Files app.
 */
class XiaoQiuDocumentsProvider : DocumentsProvider() {

    companion object {
        const val AUTHORITY = "com.xiaoqiu.xiaoqiu.documents"
        private const val ROOT_ID = "xiaoqiu-root"
    ...
    private fun providerRoot(): File {
        ...
        return File(ctx.filesDir, "xiaoqiu-global").apply { mkdirs() }
    }
    ...
    override fun queryDocument(documentId: String, projection: Array<String>?): Cursor {
        ...
        val displayName = if (documentId.isEmpty()) "XiaoQiu" else file.name
        cursor.newRow()
