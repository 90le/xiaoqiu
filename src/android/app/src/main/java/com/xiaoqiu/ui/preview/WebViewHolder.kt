package com.xiaoqiu.ui.preview
    ...
    val webView: WebView = WebView(appContext).apply {
        ...
        webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(
                ...
                if (com.xiaoqiu.browser.GoogleAuthRouter.shouldRouteExternally(urlStr)) {
                    if (urlStr != null) {
                        com.xiaoqiu.browser.GoogleAuthRouter.openInCustomTab(view.context, urlStr)
                    }
                    return true
                }
