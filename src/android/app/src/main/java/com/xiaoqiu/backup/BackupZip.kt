...
/**
 * ZIP packaging for `.xiaoqiubak`, on both sides of the wire.
 *
...
object BackupZip {
     ...
     * `xiaoqiubak-<uuid>/manifest.json` rather than bare `manifest.json`.
     */
     ...
     *
     * After extraction the real package root may be `<dest>/xiaoqiubak-<uuid>/`
