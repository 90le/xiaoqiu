...
import com.xiaoqiu.ui.chat.InputAttachment
...
internal object ChatMutationMethods {
     ...
     * [com.xiaoqiu.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = com.xiaoqiu.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                com.xiaoqiu.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[com.xiaoqiu.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", com.xiaoqiu.service.SessionActivityTracker.isActive(sessionId))
