 ...
 * once at app startup (XiaoQiuApp.onCreate) and warms a volatile cache; the
 * context-free [isEnabled] is then safe to call from any request builder.
 */
object FastModePrefs {
    private const val PREFS = "xiaoqiu_fast_mode_prefs"
    ...
    /** Capture the app context and warm the cache. Called from XiaoQiuApp.onCreate. */
