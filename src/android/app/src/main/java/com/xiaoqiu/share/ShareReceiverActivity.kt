...
class ShareReceiverActivity : ComponentActivity() {
    ...
    private fun promptProviderImportOrAttach(
        ...
        return try {
            android.app.AlertDialog.Builder(this)
                .setTitle(getString(com.xiaoqiu.R.string.share_provider_json_title))
                .setMessage(getString(com.xiaoqiu.R.string.share_provider_json_message))
                .setPositiveButton(getString(com.xiaoqiu.R.string.share_provider_json_import)) { _, _ ->
                ...
                .setNegativeButton(getString(com.xiaoqiu.R.string.share_provider_json_attach)) { _, _ ->
                    finishWithAttachmentFlow(items)
                }
                .setOnCancelListener {
    ...
    private fun importProviderJson(json: String) {
        ...
        if (label != null) {
            ...
            toast(getString(com.xiaoqiu.R.string.share_provider_json_imported, label))
        } else {
    ...
    private fun launchMainActivity() {
        ...
        when (outcome) {
            ...
            ShareHandoffPolicy.Outcome.FAILED -> {
                ...
                try {
                    toast(getString(com.xiaoqiu.R.string.share_open_app_failed))
                } catch (t: Throwable) {
    ...
    private fun mainActivityIntent(flags: Int): Intent =
        Intent(this, Class.forName("com.xiaoqiu.MainActivity")).apply {
            addFlags(flags)
