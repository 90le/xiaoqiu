...
import com.xiaoqiu.data.db.ChatDao
...
import com.xiaoqiu.data.model.ModelAttributionSnapshot
...
class ChatRepository(internal val dao: ChatDao) {
     ...
     * from [com.xiaoqiu.data.model.ContentPart]: "toolUse" / "toolResult"
     ...
     * [com.xiaoqiu.ui.chat.ChatViewModel.rerunFromToolBlock]'s block-
    ...
    // ───────────────── T188: xiaoqiu-sessions-cli backend ─────────────────
    //
    ...
    /**
     * Backs `xiaoqiu-sessions-cli list`. Returns sessions ordered by
    ...
    /**
     * Backs `xiaoqiu-sessions-cli search`. Over-fetches `limit * 3` rows
    ...
    /**
     * Backs `xiaoqiu-sessions-cli messages --id ... --offset --limit`.
    ...
    suspend fun loadMessagePage(
        ...
        // documented 600; `xiaoqiu-sessions-cli messages --full` passes
    ...
    /**
     * Paginated raw [MessageEntity] page — used by [com.xiaoqiu.share.ChatExporter]
...
/** T188: shape of a session row surfaced to `xiaoqiu-sessions-cli list`. */
...
/** T188: a single matching message returned by `xiaoqiu-sessions-cli search`. */
