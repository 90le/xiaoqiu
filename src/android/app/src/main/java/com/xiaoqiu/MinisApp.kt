...
import com.xiaoqiu.data.db.AppDatabase
import com.xiaoqiu.data.db.DatabaseVersionGuard
import com.xiaoqiu.data.repository.BackgroundSettingsRepository
...
import com.xiaoqiu.data.repository.MCPRepository
import com.xiaoqiu.data.repository.SkillRepository
import com.xiaoqiu.notification.BackgroundTaskNotifier
import com.xiaoqiu.logging.AppLogger
import com.xiaoqiu.network.NetworkMonitor
...
import com.xiaoqiu.sandbox.MountedFolderCoordinator
import com.xiaoqiu.sandbox.NativeOffloadServer
import com.xiaoqiu.sandbox.PRootKernel
import com.xiaoqiu.sandbox.RootfsManager
import com.xiaoqiu.sandbox.offload.AccessibilityOffloadHandler
import com.xiaoqiu.sandbox.offload.AlarmOffloadHandler
import com.xiaoqiu.sandbox.offload.BrowserUseOffloadHandler
import com.xiaoqiu.sandbox.offload.CalendarOffloadHandler
import com.xiaoqiu.sandbox.offload.ClipboardOffloadHandler
import com.xiaoqiu.sandbox.offload.ContactsOffloadHandler
import com.xiaoqiu.sandbox.offload.DeviceOffloadHandler
import com.xiaoqiu.sandbox.offload.LocationOffloadHandler
import com.xiaoqiu.sandbox.offload.ModelUseOffloadHandler
import com.xiaoqiu.sandbox.offload.SessionsOffloadHandler
import com.xiaoqiu.sandbox.offload.ShizukuOffloadHandler
import com.xiaoqiu.sandbox.offload.NotificationOffloadHandler
import com.xiaoqiu.sandbox.offload.OpenOffloadHandler
import com.xiaoqiu.sandbox.offload.PhotosOffloadHandler
import com.xiaoqiu.sandbox.offload.PlayerOffloadHandler
import com.xiaoqiu.sandbox.offload.SpeakOffloadHandler
...
class XiaoQiuApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        com.xiaoqiu.data.FastModePrefs.prime(this)
        ...
        // Activity context.
        com.xiaoqiu.data.AutoCompactPrefs.prime(this)
        ...
        // libs first execute.
        try {
            com.xiaoqiu.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, com.xiaoqiu.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        com.xiaoqiu.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        // [com.xiaoqiu.diagnostics.LaunchCycleBeacon].
        try {
        ...
        com.xiaoqiu.diagnostics.HangDetector.start(this)
        ...
        com.xiaoqiu.data.EnvVarPrivacyStore.init(this)
        com.xiaoqiu.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        com.xiaoqiu.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            com.xiaoqiu.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        com.xiaoqiu.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        com.xiaoqiu.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                com.xiaoqiu.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    com.xiaoqiu.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
