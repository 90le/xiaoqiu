...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun hasStoredCredential(context: Context, instanceId: String): Boolean {
            val prefs = com.xiaoqiu.util.EncryptedPrefsFactory
        ...
        fun forInstance(context: Context, instance: com.xiaoqiu.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.xiaoqiu.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.xiaoqiu.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.xiaoqiu.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.xiaoqiu.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.xiaoqiu.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
