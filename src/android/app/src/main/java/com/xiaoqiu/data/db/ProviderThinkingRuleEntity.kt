 ...
 * in [com.xiaoqiu.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    /** Stable UUID assigned at creation; the drag-reorder target and xiaoqiu-config handle. */
    ...
    /** Serialized [com.xiaoqiu.provider.thinking.ThinkingWireFormat]; null = "no opinion". */
