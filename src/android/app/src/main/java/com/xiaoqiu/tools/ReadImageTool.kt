...
object ReadImageTool {
    ...
    fun definition(): AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            ...
            "path" to AgentToolParam("string", "Linux path (e.g. /var/xiaoqiu/attachments/chart.png) or xiaoqiu:// URL (e.g. xiaoqiu://attachments/chart.png)"),
     ...
     * (`/var/xiaoqiu/{attachments,workspace,offloads,browser}/...`) resolve
    ...
    fun execute(argsJson: String, sessionId: String? = null, context: Context? = null): ToolExecutionResult {
        return try {
            ...
            val path = if (rawPath.startsWith("xiaoqiu://")) {
                "/var/xiaoqiu/" + java.net.URLDecoder.decode(rawPath.removePrefix("xiaoqiu://"), "UTF-8")
            } else rawPath
