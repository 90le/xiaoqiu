...
/**
 * `xiaoqiu-config` offload handler. Mirrors iOS `ConfigOffload.m`.
 *
...
class ConfigOffloadHandler : NativeOffloadHandler {
    private companion object {
        ...
        const val HELP_TEXT =
            "xiaoqiu-config - read or change XiaoQiu app settings (logged + revertable)\n" +
                "\n" +
                "USAGE:\n" +
                "  xiaoqiu-config <subcommand> [args]\n" +
                "\n" +
                "DISCOVERY:\n" +
    ...
    private fun cmdSet(args: OffloadArgs): NativeOffloadResult {
        ...
        // [T-android-xiaoqiu-config-set-shell-escape] (issue #36) `--file <path>`
    ...
    /**
     * [T-android-xiaoqiu-config-set-shell-escape] Read a file's text by its
