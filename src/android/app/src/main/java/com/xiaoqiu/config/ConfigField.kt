...
/**
 * One configurable setting. Concrete kinds: [com.xiaoqiu.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.xiaoqiu.config.fields.ClosureField]
...
interface ConfigField {
     ...
     * already blocks these entries, and xiaoqiu-config must not be a side door
     * around that gate.
     *
