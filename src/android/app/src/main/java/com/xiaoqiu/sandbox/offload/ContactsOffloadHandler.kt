                ...
                r = OffloadPermissionManager.requestSettingsGate(
                    OffloadPermissionManager.SettingsGateRequest(
                        ...
                        message = if (needsWrite) {
                            "XiaoQiu needs read + write contacts permission to delete entries. Open Settings to allow it."
                        } else {
                            "XiaoQiu needs contacts permission to read your address book. Open Settings to allow it."
                        },
