...
class ModelsCollection(
    ...
    override fun add(payload: ConfigValue): String {
        ...
        // (CLI-facing alias documented in `xiaoqiu-config` help). Either
    ...
    /**
     * Canonical names matching `xiaoqiu-model-use list` so the two tools
    ...
    private fun effectiveModalities(e: ModelEntry): List<String> {
        ...
        // direction-suffixed names that match `xiaoqiu-model-use list`.
