...
class DebugRPCHandler(private val context: Context) {
    ...
    private fun crashSummary(f: File): String = try {
        ...
        val frame = body.firstOrNull { it.trimStart().startsWith("at com.xiaoqiu") }
    ...
    private suspend fun handleUpdateCheck(): JSONObject {
        return when (val r = com.xiaoqiu.data.UpdateChecker.check()) {
            is com.xiaoqiu.data.UpdateChecker.CheckResult.UpdateAvailable -> JSONObject()
            ...
            com.xiaoqiu.data.UpdateChecker.CheckResult.UpToDate ->
                JSONObject().put("status", "up_to_date")
            com.xiaoqiu.data.UpdateChecker.CheckResult.NoReleaseAvailable ->
                JSONObject().put("status", "no_release")
            is com.xiaoqiu.data.UpdateChecker.CheckResult.NoApkAsset ->
                JSONObject().put("status", "no_apk_asset").put("tag_name", r.tagName)
            com.xiaoqiu.data.UpdateChecker.CheckResult.Forbidden ->
                JSONObject().put("status", "forbidden")
            com.xiaoqiu.data.UpdateChecker.CheckResult.NetworkUnreachable ->
                JSONObject().put("status", "network_unreachable")
            is com.xiaoqiu.data.UpdateChecker.CheckResult.Error ->
    ...
    private suspend fun handleUpdateDownload(params: JSONObject): JSONObject {
        ...
        return when (val r = com.xiaoqiu.data.UpdateChecker.download(context, url)) {
            is com.xiaoqiu.data.UpdateChecker.DownloadResult.Success -> JSONObject()
                .put("status", "ok")
                .put("path", r.file.absolutePath)
                .put("size", r.file.length())
            is com.xiaoqiu.data.UpdateChecker.DownloadResult.Error -> JSONObject()
                .put("status", "error")
    ...
    private fun handleUpdateInstall(params: JSONObject): JSONObject {
        ...
        val canInstall = com.xiaoqiu.data.UpdateChecker.canInstall(context)
        return try {
            com.xiaoqiu.data.UpdateChecker.installApk(context, file)
    ...
    private fun handleWriteFile(params: JSONObject): JSONObject {
        ...
        val hostFile = PRootKernel.resolveHostPath(path) ?: run {
            val rootfsDir = com.xiaoqiu.sandbox.RootfsManager.getInstance(context).rootfsDir
    ...
    private fun handlePermissionsList(): JSONObject {
        ...
        for (tool in com.xiaoqiu.offload.OffloadPermissionManager.toolRegistry) {
            arr.put(JSONObject()
                ...
                .put("currentLevel", com.xiaoqiu.offload.OffloadPermissionManager.getLevel(tool.toolName).name)
    ...
    /**
     * T344: Direct invocation of [com.xiaoqiu.sandbox.offload.ShizukuOffloadHandler]
    ...
    private fun handleShizukuExec(params: JSONObject): JSONObject {
        ...
        val handler = com.xiaoqiu.sandbox.offload.ShizukuOffloadHandler(context)
    ...
    private fun handleModelUseExec(params: JSONObject): JSONObject {
        ...
        val finalArgv: List<String> = if (params.has("input")) {
            ...
            val hostFile = com.xiaoqiu.sandbox.PRootKernel.resolveHostPath(linuxPath)
    ...
    private fun handleXiaoQiuConfigExec(params: JSONObject): JSONObject {
        ...
        return when (sub) {
            ...
            "audit-list" -> {
                ...
                com.xiaoqiu.config.ConfigBridge.auditList(limit, scope)
            }
