...
import com.xiaoqiu.deeplink.DeepLinkHandler
import com.xiaoqiu.logging.AppLogger
import com.xiaoqiu.service.SessionActivityTracker
import com.xiaoqiu.ui.navigation.AppNavigation
import com.xiaoqiu.ui.navigation.Routes
import com.xiaoqiu.ui.navigation.safeNavigate
import com.xiaoqiu.ui.NewerDatabaseGuidanceScreen
import com.xiaoqiu.ui.settings.KEY_FONT_APP_BASE
import com.xiaoqiu.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.xiaoqiu.ui.settings.KEY_LANGUAGE
import com.xiaoqiu.ui.settings.KEY_LAUNCH_SESSION
import com.xiaoqiu.ui.settings.KEY_THEME_MODE
import com.xiaoqiu.ui.settings.PREF_APPEARANCE
...
class MainActivity : ComponentActivity() {
     ...
     * [com.xiaoqiu.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.xiaoqiu.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (xiaoqiuApp == null || !xiaoqiuApp.subsystemsInitialized) {
            android.util.Log.w(
                ...
                "app subsystems not initialized (safeMode=" +
                    "${com.xiaoqiu.crash.CrashFrequencyDetector.isSafeMode()}) — " +
                    "showing crash share dialog and finishing",
            )
            com.xiaoqiu.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                com.xiaoqiu.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        com.xiaoqiu.share.ShareCoordinator.processPendingShare(this)
        ...
        if (BuildConfig.DEBUG) {
            com.xiaoqiu.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
     ...
     * is already covered by [com.xiaoqiu.ui.navigation.AppNavigation]
