package com.xiaoqiu.provider.openrouter

import android.content.Context
import com.xiaoqiu.data.model.LLMModel
import com.xiaoqiu.data.model.normalizeModalities
import com.xiaoqiu.provider.ModelsDevApi
import com.xiaoqiu.provider.applyUserAgentOverride
import com.xiaoqiu.provider.ProviderModelsCache
...
object OpenRouterModelsApi {
    ...
    suspend fun fetchModels(
        ...
        val request = Request.Builder()
            ...
            .header("HTTP-Referer", "https://github.com/OpenXiaoQiu/OpenXiaoQiu")
            .header("X-Title", "XiaoQiu App")
