...
import com.xiaoqiu.config.collections.EnvVarsCollection
import com.xiaoqiu.service.DynamicIslandSupport
import com.xiaoqiu.config.collections.GroupsCollection
import com.xiaoqiu.config.collections.ModelsCollection
import com.xiaoqiu.config.collections.ProvidersCollection
import com.xiaoqiu.config.fields.ClosureField
import com.xiaoqiu.config.fields.PrefsBoolField
import com.xiaoqiu.config.fields.PrefsDoubleField
import com.xiaoqiu.config.fields.PrefsEnumField
import com.xiaoqiu.config.fields.PrefsIntCodedEnumField
import com.xiaoqiu.config.fields.PrefsIntField
import com.xiaoqiu.config.fields.PrefsLongField
import com.xiaoqiu.config.fields.PrefsStringField
import com.xiaoqiu.config.fields.ReadOnlyField
import com.xiaoqiu.data.repository.ChatRepository
import com.xiaoqiu.data.repository.EnvVarRepository
...
internal object ConfigBuiltins {
    ...
    private fun registerAppearance(r: ConfigRegistry, context: Context) {
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = prefs,
                key = com.xiaoqiu.ui.settings.KEY_SHOW_CHAT_TITLE,
                defaultValue = true,
            )
        )
        r.register(
    ...
    private fun registerChat(r: ConfigRegistry, context: Context) {
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = appearancePrefs,
                key = com.xiaoqiu.ui.settings.KEY_KEEP_SCREEN_AWAKE,
                defaultValue = false,
            )
        )
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = appearancePrefs,
                key = com.xiaoqiu.ui.settings.KEY_TOOL_PREVIEW,
                defaultValue = true,
            )
        )
        ...
        r.register(
            PrefsBoolField(
                ...
                prefs = appearancePrefs,
                key = com.xiaoqiu.ui.settings.KEY_AUTO_FOCUS_AFTER_REPLY,
                defaultValue = true,
            )
        )
        r.register(fontScaleField(
            ...
            prefs = appearancePrefs,
            key = com.xiaoqiu.ui.settings.KEY_FONT_CHAT_INPUT,
        ))
        r.register(fontScaleField(
            ...
            prefs = appearancePrefs,
            key = com.xiaoqiu.ui.settings.KEY_FONT_MESSAGE,
        ))
    }
    ...
    private fun registerLogs(r: ConfigRegistry, context: Context) {
        ...
        r.register(
            ClosureField(
                ...
                revertable = true,
                reader = {
                    ConfigValue.Bool(com.xiaoqiu.logging.AppLogger.isEnabled(context))
                },
                writer = { v ->
                    val b = (v as? ConfigValue.Bool)?.value
                        ?: throw ConfigError.TypeMismatch("bool")
                    com.xiaoqiu.logging.AppLogger.setEnabled(context, b)
                },
            )
        )
    }
    ...
    private fun registerProviderCollections(
        ...
        r.register(com.xiaoqiu.config.collections.ThinkingRulesCollection(providerRepo))
        ...
        r.register(
            ReadOnlyField(
                ...
                reader = {
                    val cfg = providerRepo.config.value
                    val providersById = HashMap<String, com.xiaoqiu.data.model.ProviderInstance>(cfg.instances.size)
        ...
        r.register(
            ClosureField(
                ...
                risk = ConfigRisk.SENSITIVE,
                revertable = true,
                reader = { ConfigValue.Bool(com.xiaoqiu.data.EnvVarPrivacyStore.isEnabled) },
                writer = { v ->
                    val b = (v as? ConfigValue.Bool)?.value
                        ?: throw ConfigError.TypeMismatch("bool")
                    com.xiaoqiu.data.EnvVarPrivacyStore.setEnabled(b)
                },
            )
        )
        ...
        r.register(
            ReadOnlyField(
                ...
                reader = {
                    val cfg = providerRepo.config.value
                    val entriesById =
                        HashMap<String, com.xiaoqiu.data.model.ModelEntry>(cfg.modelEntries.size)
                    for (e in cfg.modelEntries) entriesById[e.id] = e
                    val providersById =
                        HashMap<String, com.xiaoqiu.data.model.ProviderInstance>(cfg.instances.size)
                    for (inst in cfg.instances) providersById[inst.id] = inst
                    ConfigValue.Arr(
    ...
    private fun resolveSoulIconImage(context: Context, raw: String): String {
        val icon = com.xiaoqiu.agent.SoulIcon
        val bytes: ByteArray = when (val src = icon.classifySource(raw)) {
            is com.xiaoqiu.agent.SoulIcon.Source.Unsupported ->
                throw ConfigError.InvalidValue(src.reason)

            is com.xiaoqiu.agent.SoulIcon.Source.Bytes -> src.data

            is com.xiaoqiu.agent.SoulIcon.Source.LinuxPath -> {
                ...
                val kernel = com.xiaoqiu.sandbox.PRootKernel
        ...
        return when (val r = icon.encode(bitmap)) {
            is com.xiaoqiu.agent.SoulIcon.EncodeResult.Success -> r.dataUri
            is com.xiaoqiu.agent.SoulIcon.EncodeResult.Failure -> when (r.reason) {
                com.xiaoqiu.agent.SoulIcon.Rejection.TOO_LARGE ->
                    throw ConfigError.InvalidValue("that image is too large to store inline")
                com.xiaoqiu.agent.SoulIcon.Rejection.UNREADABLE ->
    ...
    private fun registerSoul(r: ConfigRegistry, context: Context) {
        ...
        // English ≤ 500 words); see [com.xiaoqiu.agent.SoulStore.isOverLimit].
        ...
        fun loadCurrent(): com.xiaoqiu.agent.SoulFile =
            com.xiaoqiu.agent.SoulStore.load(context)
                ?: com.xiaoqiu.agent.SoulMDParser.parse(
                    com.xiaoqiu.agent.SoulStore.DEFAULT_CONTENT
                )

        fun saveCurrent(file: com.xiaoqiu.agent.SoulFile) {
            com.xiaoqiu.agent.SoulStore.save(context, file)
        }
            ...
            ClosureField(
                ...
                writer = { v ->
                    ...
                    val name = raw.trim().ifBlank {
                        com.xiaoqiu.agent.SoulMetadata.DEFAULT.name
                    }
                    val cur = loadCurrent()
        ...
        r.register(
            ClosureField(
                ...
                description = "The Soul's identity icon — also called its avatar, its persona image, or its " +
                    ...
                    "square, downscaled to ${com.xiaoqiu.agent.SoulIcon.STORED_PIXELS}×" +
                    "${com.xiaoqiu.agent.SoulIcon.STORED_PIXELS}, re-encoded as PNG and stored inline.\n" +
                    "\n" +
                ...
                reader = {
                    ...
                    ConfigValue.Str(
                        if (com.xiaoqiu.agent.SoulIcon.isDataUri(raw)) "<image>" else raw,
                    )
                },
                writer = { v ->
                    val raw = (v as? ConfigValue.Str)?.value
                    ...
                    val next = when {
                        ...
                        com.xiaoqiu.agent.SoulIcon.graphemeClusters(trimmed).size == 1 &&
                            com.xiaoqiu.agent.SoulIcon.isEmojiGlyph(trimmed) -> trimmed
            ...
            ClosureField(
                ...
                reader = {
                    ...
                    ConfigValue.Str(cur.metadata.lang.ifBlank {
                        com.xiaoqiu.agent.SoulMetadata.DEFAULT.lang
                    })
                },
                writer = { v ->
                    val raw = (v as? ConfigValue.Str)?.value
        ...
        r.register(
            ClosureField(
                ...
                description = "Personality / voice instructions injected as a block in the system prompt. Length cap is language-aware: Chinese ≤ ${com.xiaoqiu.agent.SoulStore.CHINESE_CHAR_LIMIT} chars OR English ≤ ${com.xiaoqiu.agent.SoulStore.ENGLISH_WORD_LIMIT} words (rule picked by the majority language). The writer also rejects prompt-injection patterns (\"ignore previous instructions\" etc.) — keep this to genuine character / tone guidance.",
                ...
                writer = { v ->
                    val raw = (v as? ConfigValue.Str)?.value
                        ?: throw ConfigError.TypeMismatch("string")
                    if (com.xiaoqiu.agent.SystemPromptBuilder
                    ...
                    val check = com.xiaoqiu.agent.SoulStore.isOverLimit(raw)
                    when (check) {
                        is com.xiaoqiu.agent.SoulBodyLimitCheck.Ok -> Unit
                        is com.xiaoqiu.agent.SoulBodyLimitCheck.OverLimitChinese ->
                            throw ConfigError.InvalidValue(
                                "Over limit: ${check.chars} Chinese chars exceeds cap of ${check.cap}. Either trim to ≤ ${check.cap} chars, or rewrite mostly in English to use the ≤ ${com.xiaoqiu.agent.SoulStore.ENGLISH_WORD_LIMIT}-word cap."
                            )
                        is com.xiaoqiu.agent.SoulBodyLimitCheck.OverLimitEnglish ->
                            throw ConfigError.InvalidValue(
                                "Over limit: ${check.words} English words exceeds cap of ${check.cap}. Either trim to ≤ ${check.cap} words, or rewrite mostly in Chinese to use the ≤ ${com.xiaoqiu.agent.SoulStore.CHINESE_CHAR_LIMIT}-char cap."
                            )
                    }
                    val cur = loadCurrent()
