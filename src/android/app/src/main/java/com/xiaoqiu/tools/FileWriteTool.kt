...
object FileWriteTool {
    ...
    fun execute(argsJson: String, sessionId: String, context: Context): ToolExecutionResult {
        return try {
            ...
            // T123: per-session resolver so /var/xiaoqiu/workspace/...,
            // /var/xiaoqiu/attachments/..., /var/xiaoqiu/offloads/...,
            // /var/xiaoqiu/browser/... land in this session's host dir
            ...
            // /var/xiaoqiu/workspace/foo/bar.md would otherwise hit "Parent
            ...
            if (path.startsWith("/var/xiaoqiu/mounts/")) {
