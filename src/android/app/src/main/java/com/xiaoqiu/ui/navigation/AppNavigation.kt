package com.xiaoqiu.ui.navigation
...
import com.xiaoqiu.deeplink.DeepLinkAction
import com.xiaoqiu.deeplink.DeepLinkCoordinator
import com.xiaoqiu.ui.settings.KEY_LAUNCH_SESSION
...
import com.xiaoqiu.ui.chat.ChatScreen
import com.xiaoqiu.ui.sessions.SessionListScreen
import com.xiaoqiu.ui.settings.AboutScreen
import com.xiaoqiu.ui.settings.AddAgentLoopGroupsScreen
import com.xiaoqiu.ui.settings.AddAgentLoopModelsScreen
import com.xiaoqiu.ui.settings.AddCustomModelScreen
import com.xiaoqiu.ui.settings.BackgroundSettingsScreen
import com.xiaoqiu.ui.settings.AddModelsToGroupScreen
import com.xiaoqiu.ui.settings.ShadowVoiceDetailScreen
import com.xiaoqiu.ui.settings.AddProviderScreen
import com.xiaoqiu.ui.settings.ModelEntryDetailScreen
import com.xiaoqiu.ui.settings.ModelGroupDetailScreen
import com.xiaoqiu.ui.settings.ModelGroupsScreen
import com.xiaoqiu.ui.settings.ProviderDetailScreen
import com.xiaoqiu.ui.settings.ProviderListScreen
import com.xiaoqiu.ui.sandbox.FileBrowserScreen
import com.xiaoqiu.ui.sandbox.FileBrowserViewModel
import com.xiaoqiu.ui.sandbox.FileItem
import com.xiaoqiu.ui.sandbox.FilePreviewScreen
import com.xiaoqiu.ui.sandbox.RootfsManagementScreen
import com.xiaoqiu.ui.settings.EnvironmentVariablesScreen
import com.xiaoqiu.ui.settings.AppearanceScreen
import com.xiaoqiu.ui.settings.SettingsScreen
import com.xiaoqiu.ui.settings.SystemPermissionsScreen
import com.xiaoqiu.ui.settings.SessionStorageDetailScreen
import com.xiaoqiu.ui.settings.SkillDetailScreen
...
import com.xiaoqiu.ui.settings.SharedFoldersScreen
import com.xiaoqiu.ui.settings.SkillsManagementScreen
import com.xiaoqiu.data.repository.EnvVarRepository
import com.xiaoqiu.data.repository.MemoryRepository
import com.xiaoqiu.data.repository.SkillRepository
import com.xiaoqiu.ui.settings.LogDetailScreen
import com.xiaoqiu.ui.settings.LogManagementScreen
import com.xiaoqiu.ui.settings.MemoryFileEditScreen
import com.xiaoqiu.ui.settings.MemoryManagementScreen
import com.xiaoqiu.ui.settings.OffloadPermissionScreen
import com.xiaoqiu.ui.settings.ShizukuPermissionScreen
import com.xiaoqiu.sandbox.RootfsManager
import com.xiaoqiu.sandbox.TerminalSession
import com.xiaoqiu.ui.terminal.TerminalScreen
import com.xiaoqiu.ui.onboarding.OnboardingModelSelectionScreen
...
fun AppNavigation(
    ...
    LaunchedEffect(Unit) {
        ...
        val hasPendingShare =
            com.xiaoqiu.share.ShareCoordinator.bufferVersion.value > 0
        ...
        val mode = if (
            com.xiaoqiu.diagnostics.HangDetector.shouldForceHomeOnLaunch(context) ||
            com.xiaoqiu.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(context) ||
            com.xiaoqiu.diagnostics.LaunchCycleBeacon.shouldForceHomeOnLaunch()
        ) 3 else rawMode
    ...
    NavHost(
        ...
        composable(Routes.BACKUP) {
            com.xiaoqiu.ui.settings.backup.BackupAndRestoreScreen(
                onBack = { navController.safePopBackStack() },
        ...
        composable(
            ...
            val history = remember { com.xiaoqiu.backup.BackupHistory.get(ctx) }
            ...
            if (record == null) {
                ...
                // the screen.
                val vm: com.xiaoqiu.ui.settings.backup.BackupViewModel =
                    androidx.lifecycle.viewmodel.compose.viewModel()
                com.xiaoqiu.ui.settings.backup.BackupHistoryDetailScreen(
                    record = record,
                    onBack = { navController.safePopBackStack() },
                    onRemove = {
                        history.remove(id)
        ...
        composable(
            ...
            val remote = remember(name) {
                com.xiaoqiu.backup.remote.RcloneRemoteStore(ctx).remote(name)
            }
            if (remote == null) {
                ...
                val vm: com.xiaoqiu.ui.settings.backup.BackupViewModel =
                    androidx.lifecycle.viewmodel.compose.viewModel()
                com.xiaoqiu.ui.settings.backup.BackupDestinationBrowseScreen(
                    remote = remote,
                    vm = vm,
                    onBack = { navController.safePopBackStack() },
                )
        ...
        composable(Routes.RESTORE_SERVERS) {
            com.xiaoqiu.ui.settings.backup.RestoreServersScreen(
                onBack = { navController.safePopBackStack() },
                onPickServer = { name ->
                    navController.safeNavigate(
                        "${Routes.RESTORE_BROWSE}/" + android.net.Uri.encode(name),
        ...
        composable(
            ...
            if (remote == null) {
                ...
                com.xiaoqiu.ui.settings.backup.RestoreBrowseScreen(
                    remote = remote,
                    vm = vm,
                    onBack = { navController.safePopBackStack() },
        ...
        composable(Routes.BACKUP_DESTINATIONS) {
            com.xiaoqiu.ui.settings.backup.RcloneDestinationsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
            ...
            SharedFolderDetailScreen(
                ...
                onBrowseFiles = {
                    ...
                    val label = when (folderId) {
                        ...
                        "memory" -> ctx.getString(com.xiaoqiu.R.string.shared_folder_name_memory)
                        else -> folderId
                    }
        ...
        composable(
            ...
            val category = com.xiaoqiu.ui.sandbox.MirrorCatalog.categoryFromKey(categoryKey)
                ?: return@composable
            com.xiaoqiu.ui.sandbox.MirrorCategoryDetailScreen(
                category = category,
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.MCP) {
            if (mcpRepository != null) {
                com.xiaoqiu.ui.settings.MCPIntegrationsScreen(
                    mcpRepository = mcpRepository,
                    onBack = { navController.safePopBackStack() },
                    envVarRepository = envVarRepository,
                )
        ...
        composable(Routes.SOUL) {
            com.xiaoqiu.ui.settings.SoulSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SCHEDULED_TASKS) {
            com.xiaoqiu.ui.scheduled.ScheduledTasksScreen(
                onBack = { navController.safePopBackStack() },
                onEditTask = { taskId ->
        ...
        composable(
            ...
            com.xiaoqiu.ui.scheduled.ScheduledTaskRunsScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
        ...
        composable(
            ...
            com.xiaoqiu.ui.scheduled.ScheduledTaskEditScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
