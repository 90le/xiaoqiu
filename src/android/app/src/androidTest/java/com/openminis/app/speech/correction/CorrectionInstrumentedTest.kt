package com.xiaoqiu.speech.correction
...
class CorrectionInstrumentedTest {
    ...
    private val seg: (String) -> List<String> = {
        com.xiaoqiu.shared.TextSegmenter.getInstance(ctx).segment(it)
    }
    ...
    @Test fun posTagAndBackgroundListAreAvailable() {
        val tagged = com.xiaoqiu.shared.TextSegmenter.getInstance(ctx)
